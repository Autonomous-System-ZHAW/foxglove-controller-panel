...
export function GamepadView(props: {
  ...
  // Trigger normalisieren (-1..1 → 0..100)
const pressed = (index: number) => joy?.buttons?.[index] === 1;
...
const CROSS_DOWN = 12;
const CROSS_LEFT = 13;
const CROSS_RIGHT = 14;

// Trigger normalisieren
const l2Raw = joy?.axes?.[4] ?? -1;
const r2Raw = joy?.axes?.[5] ?? -1;

const normalizeTrigger = (v: number) =>
  Math.round(((1 - v) / 2) * 100);

const l2 = normalizeTrigger(l2Raw);
const r2 = normalizeTrigger(r2Raw);

const lx = -(joy?.axes?.[0] ?? 0);
const ly = -(joy?.axes?.[1] ?? 0);

const rx = -(joy?.axes?.[2] ?? 0);
const ry = -(joy?.axes?.[3] ?? 0);
      ...
      >
          <g id="Button_infills">
            ...
            <g id="Down_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(CROSS_DOWN) ? "#1e90ff" : "#222"}
            ...
            <g id="Right_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(CROSS_RIGHT) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
            <g id="Left_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(CROSS_LEFT) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
            <g id="Up_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(CROSS_UP) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
            <g id="Triangle_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(TRIANGLE) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
            ...
            <g id="Circle_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(CIRCLE) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
            <g id="Square_infill" transform="translate(0,0.65) scale(0.70)">
              ...
              fill={pressed(SQUARE) ? "#1e90ff" : "#222"}
              style={{ transition: "fill 0.1s ease" }}/>
            </g>
          ...
          <g id="L3" transform="translate(0,0.65) scale(0.70)">
            <g id="L3_infill">
              <path d="M295.63,461.03c23.36,0,41.53-17.87,41.57-40.86.03-23.53-18.65-42.27-42.16-42.27-23.09,0-41.82,18.55-41.83,41.45-.01,23.9,18.09,41.69,42.42,41.69Z"
                transform={`translate(${lx * STICK_RANGE}, ${ly * STICK_RANGE})`}
                fill={pressed(L3_BTN) ? "#1e90ff" : "#000000"}/>
            </g>
            <g id="L3_outline">
          ...
          <g id="R3" transform="translate(0,0.65) scale(0.70)">
            <g id="R3_infill">
              ...
              transform={`translate(${rx * STICK_RANGE}, ${ry * STICK_RANGE})`}
              fill={pressed(R3_BTN) ? "#1e90ff" : "#000000"}
              />
            </g>
            <g id="R3_outline">
          ...
          <g id="TriggerPercentages" transform="translate(0,0.65) scale(0.70)">
            <text id="L2_percentage" x="160" y="80" font-family="Arial, sans-serif" font-size="24" font-weight="bold" fill="#ffffff" text-anchor="middle" opacity="0">0 %</text>
            <text id="R2_percentage" x="750" y="80" font-family="Arial, sans-serif" font-size="24" font-weight="bold" fill="#ffffff" text-anchor="middle" opacity="0">0 %</text>
          </g>
